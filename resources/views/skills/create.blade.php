<x-app-layout title="Create Skill">
    <x-slot name="header">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                :value="old('name')" placeholder="e.g. Laravel" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="category" name="category" type="text" class="mt-1 block w-full"
                                :value="old('category')" placeholder="e.g. Backend, Frontend, Database" required />
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center gap-4">
                                <input id="level" name="level" type="range" min="0" max="100"
                                    step="1" value="{{ old('level', 50) }}" class="flex-1 accent-indigo-600"
