                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                :value="old('name', $skill->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center gap-4">
                                <input id="level" name="level" type="range" min="0" max="100"
                                    step="1" value="{{ old('level', $skill->level) }}"
                            ...
                            <div class="mt-2 bg-gray-200 dark:bg-gray-600 rounded-full h-2 overflow-hidden">
                                <div id="level-bar" class="bg-indigo-500 h-2 rounded-full transition-all"
                        ...
                        <div>
                            ...
                            @if ($skill->icon)
                                <div class="mt-2 mb-3 flex items-center gap-3">
                                    <img src="{{ Storage::url($skill->icon) }}" id="icon-preview"
                                        alt="{{ $skill->name }}"
                                        class="w-12 h-12 object-contain rounded border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 p-1">
                                    <span class="text-xs text-gray-500 dark:text-gray-400">Icon saat ini. Upload baru
                            ...
                            <input id="icon" name="icon" type="file" accept="image/*,image/svg+xml"
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">JPG, PNG, WebP, SVG. Maks 1 MB.
