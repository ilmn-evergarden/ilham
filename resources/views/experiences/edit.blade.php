<x-app-layout title="Edit Experience">
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Edit Pengalaman') }}: <span class="text-indigo-600 dark:text-indigo-400">{{ $experience->company }}</span>
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('experiences.update', $experience) }}" id="exp-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-5">
                        ...
                        @php
                            $isCurrent = old('is_current', $experience->is_current);
                        @endphp
                        <div id="end-date-wrapper" class="{{ $isCurrent ? 'hidden' : '' }}">
    ...
    <script>
        ...
        // Run on page load to handle pre-filled state
        (function () {
