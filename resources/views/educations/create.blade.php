<x-app-layout title="Create Education">
    <x-slot name="header">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select id="level" name="level" required
                                ...
                                <option value="" disabled @selected(!old('level'))>-- Pilih Jenjang --</option>
                        ...
                        <div>
                            ...
                            <x-text-input
                                ...
                                placeholder="e.g. Universitas Bahaudin Mudhary Madura"
                                required autofocus
                            />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                name="description"
                                rows="4"
                                placeholder="Ceritakan kegiatan, prestasi, atau hal menarik selama menempuh pendidikan ini..."
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 shadow-sm focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 text-sm"
