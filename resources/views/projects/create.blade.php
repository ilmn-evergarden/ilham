            ...
            <form method="POST" action="{{ route('projects.store') }}" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-1 block w-full"
                                :value="old('title')" placeholder="e.g. Sistem Informasi Akademik"
                        ...
                        <div>
                            ...
                            <x-text-input id="slug" name="slug" type="text" class="mt-1 block w-full"
                                :value="old('slug')" placeholder="auto-generated dari judul" required />
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Dibuat otomatis. Bisa diedit secara manual.</p>
                            ...
                            <div>
                                ...
                                <select id="status" name="status" required
                                    ...
                                    @foreach (\App\Models\Project::statuses() as $s)
                                        <option value="{{ $s }}" @selected(old('status', 'Development') === $s)>{{ $s }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="flex items-center justify-end gap-3">
                        ...
                        <x-primary-button type="submit">Simpan Project</x-primary-button>
                    </div>
