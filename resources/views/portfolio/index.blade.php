    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div class="flex flex-col md:flex-row items-center justify-between">
            <div class="md:w-1/2 text-center md:text-left reveal">
                <h1 class="text-4xl md:text-6xl font-extrabold font-serif tracking-tight mb-4 text-[#222] dark:text-[#ddd]">
            ...
            <div class="md:w-1/2 mt-12 md:mt-0 flex justify-center reveal" style="transition-delay: 200ms;">
                <div class="relative w-64 h-64 md:w-96 md:h-96">
                    ...
                    @if($user->profile && $user->profile->photo)
                        <img src="{{ Storage::url($user->profile->photo) }}" alt="{{ $user->name }}" loading="lazy" class="relative z-10 w-full h-full object-cover rounded-full border-4 border-white dark:border-slate-800 shadow-2xl">
                    @else
                        <div class="relative z-10 w-full h-full rounded-full border-4 border-white dark:border-[#383848] shadow-2xl bg-[#f2f2f2] dark:bg-[#383848] flex items-center justify-center">
...
<!-- Skills Section -->
<section id="skills" class="py-20 bg-[#f2f2f2] dark:bg-[#111] border-y border-[#e1e1e1] dark:border-[#383848] relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 reveal">
            <h2 class="text-3xl font-bold font-serif text-[#222] dark:text-[#ddd] inline-block relative">
                Skills & Expertise
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <div class="flex justify-between mb-1">
                            <span class="text-sm font-medium flex items-center gap-2 text-[#555] dark:text-[#a4a4a4]">
                                @if($skill->icon)
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
                ...
                <div class="space-y-8 pl-4 border-l-2 border-[#e1e1e1] dark:border-[#383848]">
                    ...
                    <div class="timeline-item reveal relative pl-8 before:absolute before:left-[-6px] before:top-2 before:w-3 before:h-3 before:bg-primary before:rounded-full">
                        <span class="text-sm font-medium text-primary mb-2 inline-block">
                            {{ $exp->start_date->format('M Y') }} - {{ $exp->is_current ? 'Present' : ($exp->end_date ? $exp->end_date->format('M Y') : 'N/A') }}
                        </span>
                        <h3 class="text-xl font-bold text-[#222] dark:text-[#ddd] mt-1">{{ $exp->position }}</h3>
                        <h4 class="text-md font-medium text-[#555] dark:text-[#a4a4a4] mb-3">{{ $exp->company }} <span class="text-sm font-normal text-[#999]">({{ $exp->employment_type }})</span></h4>
            ...
            <div>
                ...
                <div class="space-y-8 pl-4 border-l-2 border-[#e1e1e1] dark:border-[#383848]">
                    ...
                    <div class="timeline-item reveal relative pl-8 before:absolute before:left-[-6px] before:top-2 before:w-3 before:h-3 before:bg-primary before:rounded-full">
                        ...
                        <h4 class="text-md font-medium text-[#555] dark:text-[#a4a4a4] mb-3">{{ $edu->school_name }} <span class="text-sm font-normal text-[#999]">({{ $edu->level }})</span></h4>
                        <p class="text-[#555] dark:text-[#a4a4a4] text-sm leading-relaxed">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <x-card class="reveal flex flex-col h-full group p-0 overflow-hidden">
                ...
                <div class="p-6 flex flex-col flex-grow">
                    <h3 class="text-xl font-bold mb-2 font-serif group-hover:text-primary transition-colors text-[#222] dark:text-[#ddd]">{{ $project->title }}</h3>
...
<!-- Certificates -->
<section id="certificates" class="py-20 bg-[#f2f2f2] dark:bg-[#111] border-y border-[#e1e1e1] dark:border-[#383848] relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 reveal">
            <h2 class="text-3xl font-bold font-serif text-[#222] dark:text-[#ddd] inline-block relative">
                Certificates
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <x-card class="text-center reveal group">
                <div class="w-16 h-16 mx-auto bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center mb-4 text-primary group-hover:scale-110 transition-transform">
                ...
                <a href="{{ $cert->credential_url }}" target="_blank" class="inline-flex items-center justify-center px-4 py-2 text-xs font-medium rounded bg-[#e1e1e1] dark:bg-[#383848] hover:bg-primary hover:text-white transition-colors">
...
<section id="contact" class="py-20 relative z-10">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <x-card class="text-center reveal">
            <h2 class="text-3xl md:text-5xl font-bold font-serif mb-6 text-[#222] dark:text-[#ddd] inline-block">Let's Work Together</h2>
